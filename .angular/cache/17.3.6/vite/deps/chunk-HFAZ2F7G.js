...
var convertToPublic = function(e) {
  return { vattrs: e.C, vchildren: e.N, vkey: e.R, vname: e.D, vtag: e.$, vtext: e._ };
};
...
var clientHydrate = function(e, t, r, n, a, i, o) {
  ...
  if (i.nodeType === 1) {
    ...
    if (l) {
      s = l.split(".");
      if (s[0] === o || s[0] === "0") {
        u = { i: 0, H: s[0], L: s[1], O: s[2], M: s[3], $: i.tagName.toLowerCase(), k: i, C: null, N: null, R: null, D: null, _: null };
        t.push(u);
    ...
    if (s[1] === o || s[1] === "0") {
      l = s[0];
      u = { i: 0, H: s[1], L: s[2], O: s[3], M: s[4], k: i, C: null, N: null, R: null, D: null, $: null, _: null };
      if (l === TEXT_NODE_ID) {
        u.k = i.nextSibling;
...
@ionic/core/dist/esm-es5/index-8808daa5.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-HFAZ2F7G.js.map
