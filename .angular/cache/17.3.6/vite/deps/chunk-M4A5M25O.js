...
function createV3Controller(config) {
  return __async(this, null, function* () {
    ...
    const controller = yield import("./StandardController-HRVJJMJ2.js");
...
function createController(config) {
  return __async(this, null, function* () {
    ...
    if (teamsApp.isAvailable()) {
      const controller = yield import("./NestedAppAuthController-I7GPRUOJ.js");
...
function getPerfMeasurementModule() {
  ...
  try {
    ...
    if (Number(perfEnabled) === 1) {
      return import("./BrowserPerformanceMeasurement-KUYUMGYB.js");
    }
  } catch (e) {
  }
  return void 0;
...
@azure/msal-browser/dist/index.mjs:
  (*! @azure/msal-browser v3.14.0 2024-05-07 *)
*/
//# sourceMappingURL=chunk-M4A5M25O.js.map
